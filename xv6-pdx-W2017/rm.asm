...
000003e7 <chgrp>:
SYSCALL(chgrp)
 3e7:	b8 22 00 00 00       	mov    $0x22,%eax
 3ec:	cd 40                	int    $0x40
 3ee:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 407:	e8 fb fe ff ff       	call   307 <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 424:	74 17                	je     43d <printint+0x2b>
 426:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 42a:	79 11                	jns    43d <printint+0x2b>
    neg = 1;
 ...
 43b:	eb 06                	jmp    443 <printint+0x31>
  } else {
    x = xx;
 ...
 443:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 44a:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 44d:	8d 41 01             	lea    0x1(%ecx),%eax
 ...
 462:	0f b6 80 fc 0a 00 00 	movzbl 0xafc(%eax),%eax
 469:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 ...
 481:	75 c7                	jne    44a <printint+0x38>
  if(neg)
 483:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 487:	74 2d                	je     4b6 <printint+0xa4>
    buf[i++] = '-';
 ...
 492:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
  ...
  while(--i >= 0)
 497:	eb 1d                	jmp    4b6 <printint+0xa4>
    putc(fd, buf[i]);
 ...
 4ae:	e8 3c ff ff ff       	call   3ef <putc>
 ...
 4be:	79 d9                	jns    499 <printint+0x87>
    putc(fd, buf[i]);
}
 4c0:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 523:	e8 c7 fe ff ff       	call   3ef <putc>
 ...
 54d:	e8 c0 fe ff ff       	call   412 <printint>
 ...
 577:	e8 96 fe ff ff       	call   412 <printint>
 ...
 59e:	75 25                	jne    5c5 <printf+0xff>
          s = "(null)";
 5a0:	c7 45 f4 a9 08 00 00 	movl   $0x8a9,-0xc(%ebp)
        while(*s != 0){
 ...
 5b9:	e8 31 fe ff ff       	call   3ef <putc>
 ...
 5e6:	e8 04 fe ff ff       	call   3ef <putc>
 ...
 607:	e8 e3 fd ff ff       	call   3ef <putc>
 ...
 619:	e8 d1 fd ff ff       	call   3ef <putc>
 ...
 62e:	e8 bc fd ff ff       	call   3ef <putc>
...
free(void *ap)
{
 ...
 666:	a1 18 0b 00 00       	mov    0xb18,%eax
...
free(void *ap)
{
 ...
 731:	a3 18 0b 00 00       	mov    %eax,0xb18
}
 736:	90                   	nop
 737:	c9                   	leave  
 738:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 758:	50                   	push   %eax
 759:	e8 11 fc ff ff       	call   36f <sbrk>
 ...
 78f:	83 c4 10             	add    $0x10,%esp
  return freep;
 792:	a1 18 0b 00 00       	mov    0xb18,%eax
}
 797:	c9                   	leave  
 798:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ab:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7ae:	a1 18 0b 00 00       	mov    0xb18,%eax
 7b3:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7b6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7ba:	75 23                	jne    7df <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7bc:	c7 45 f0 10 0b 00 00 	movl   $0xb10,-0x10(%ebp)
 7c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7c6:	a3 18 0b 00 00       	mov    %eax,0xb18
 7cb:	a1 18 0b 00 00       	mov    0xb18,%eax
 7d0:	a3 10 0b 00 00       	mov    %eax,0xb10
    base.s.size = 0;
 7d5:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 7dc:	00 00 00 
  }
 ...
 832:	a3 18 0b 00 00       	mov    %eax,0xb18
      return (void*)(p + 1);
 ...
 83d:	eb 3b                	jmp    87a <malloc+0xe1>
    ...
    if(p == freep)
 83f:	a1 18 0b 00 00       	mov    0xb18,%eax
