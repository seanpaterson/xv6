...
printint(int fd, int xx, int base, int sgn)
{
 ...
 462:	0f b6 80 04 0b 00 00 	movzbl 0xb04(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 59e:	75 25                	jne    5c5 <printf+0xff>
          s = "(null)";
 5a0:	c7 45 f4 af 08 00 00 	movl   $0x8af,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 666:	a1 20 0b 00 00       	mov    0xb20,%eax
...
free(void *ap)
{
 ...
 731:	a3 20 0b 00 00       	mov    %eax,0xb20
}
 736:	90                   	nop
 737:	c9                   	leave  
 738:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 78f:	83 c4 10             	add    $0x10,%esp
  return freep;
 792:	a1 20 0b 00 00       	mov    0xb20,%eax
}
 797:	c9                   	leave  
 798:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7bc:	c7 45 f0 18 0b 00 00 	movl   $0xb18,-0x10(%ebp)
 7c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7c6:	a3 20 0b 00 00       	mov    %eax,0xb20
 7cb:	a1 20 0b 00 00       	mov    0xb20,%eax
 7d0:	a3 18 0b 00 00       	mov    %eax,0xb18
    base.s.size = 0;
 7d5:	c7 05 1c 0b 00 00 00 	movl   $0x0,0xb1c
 7dc:	00 00 00 
  }
 ...
 832:	a3 20 0b 00 00       	mov    %eax,0xb20
      return (void*)(p + 1);
 ...
 83d:	eb 3b                	jmp    87a <malloc+0xe1>
    ...
    if(p == freep)
 83f:	a1 20 0b 00 00       	mov    0xb20,%eax
