...
// add support for built-ins here. cd is a built-in
    ...
    if (buf[0]=='_') {     // assume it is a builtin command
     64e:	0f b6 05 20 1e 00 00 	movzbl 0x1e20,%eax
     655:	3c 5f                	cmp    $0x5f,%al
     657:	75 12                	jne    66b <main+0xd0>
      dobuiltin(buf);
     659:	83 ec 0c             	sub    $0xc,%esp
     65c:	68 20 1e 00 00       	push   $0x1e20
    ...
    if(fork1() == 0)
     ...
     677:	68 20 1e 00 00       	push   $0x1e20
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     698:	6a 64                	push   $0x64
     69a:	68 20 1e 00 00       	push   $0x1e20
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     6c0:	68 29 18 00 00       	push   $0x1829
     6c5:	6a 02                	push   $0x2
     6c7:	e8 00 0d 00 00       	call   13cc <printf>
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     6eb:	68 2d 18 00 00       	push   $0x182d
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     706:	6a 54                	push   $0x54
     708:	e8 92 0f 00 00       	call   169f <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     73c:	6a 18                	push   $0x18
     73e:	e8 5c 0f 00 00       	call   169f <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     79f:	6a 0c                	push   $0xc
     7a1:	e8 f9 0e 00 00       	call   169f <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     7e7:	6a 0c                	push   $0xc
     7e9:	e8 b1 0e 00 00       	call   169f <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     82f:	6a 08                	push   $0x8
     831:	e8 69 0e 00 00       	call   169f <malloc>
     ...
     875:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     88d:	50                   	push   %eax
     88e:	68 fc 1d 00 00       	push   $0x1dfc
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     936:	50                   	push   %eax
     937:	68 fc 1d 00 00       	push   $0x1dfc
     ...
     954:	50                   	push   %eax
     955:	68 04 1e 00 00       	push   $0x1e04
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     997:	50                   	push   %eax
     998:	68 fc 1d 00 00       	push   $0x1dfc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     9de:	50                   	push   %eax
     9df:	68 fc 1d 00 00       	push   $0x1dfc
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     a62:	68 32 18 00 00       	push   $0x1832
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     a84:	50                   	push   %eax
     a85:	68 33 18 00 00       	push   $0x1833
     a8a:	6a 02                	push   $0x2
     a8c:	e8 3b 09 00 00       	call   13cc <printf>
     a91:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     a94:	83 ec 0c             	sub    $0xc,%esp
     a97:	68 42 18 00 00       	push   $0x1842
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     afc:	68 49 18 00 00       	push   $0x1849
  ...
  if(peek(ps, es, ";")){
     ...
     b16:	68 4b 18 00 00       	push   $0x184b
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     b84:	68 4d 18 00 00       	push   $0x184d
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     c13:	68 4f 18 00 00       	push   $0x184f
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     c99:	68 6c 18 00 00       	push   $0x186c
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     cc2:	68 6f 18 00 00       	push   $0x186f
    ...
    panic("parseblock");
     ...
     cdc:	68 71 18 00 00       	push   $0x1871
  ...
  if(!peek(ps, es, ")"))
     ...
     d12:	68 7c 18 00 00       	push   $0x187c
    ...
    panic("syntax - missing )");
     ...
     d2c:	68 7e 18 00 00       	push   $0x187e
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     d70:	68 6f 18 00 00       	push   $0x186f
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     dfa:	68 42 18 00 00       	push   $0x1842
    ...
    if(argc >= MAXARGS)
     ...
     e31:	68 91 18 00 00       	push   $0x1891
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     e58:	68 9f 18 00 00       	push   $0x189f
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ebe:	8b 04 85 a4 18 00 00 	mov    0x18a4(,%eax,4),%eax
     ec5:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
000012d5 <setpriority>:
SYSCALL(setpriority)
    12d5:	b8 1f 00 00 00       	mov    $0x1f,%eax
    12da:	cd 40                	int    $0x40
    12dc:	c3                   	ret    

000012dd <chmod>:
SYSCALL(chmod)
    12dd:	b8 20 00 00 00       	mov    $0x20,%eax
    12e2:	cd 40                	int    $0x40
    12e4:	c3                   	ret    

000012e5 <chown>:
SYSCALL(chown)
    12e5:	b8 21 00 00 00       	mov    $0x21,%eax
    12ea:	cd 40                	int    $0x40
    12ec:	c3                   	ret    

000012ed <chgrp>:
SYSCALL(chgrp)
    12ed:	b8 22 00 00 00       	mov    $0x22,%eax
    12f2:	cd 40                	int    $0x40
    12f4:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    130d:	e8 fb fe ff ff       	call   120d <write>
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    165e:	50                   	push   %eax
    165f:	e8 11 fc ff ff       	call   1275 <sbrk>
